...
#endif
const float Projectile::DEFAULT_PROJECTILE_FIRE_RATE = 0.3f; // Example value, adjust as needed
const float Projectile::DEFAULT_SIZE = 20.0f;               // Example size
const float Projectile::DEFAULT_SPEED = 500.0f;             // Example speed
const float Projectile::DEFAULT_RANGE = 1000.0f;            // Example range
...
const float Projectile::MISSILE_SPEED = 600.0f; // Adjust as needed
const float Projectile::MISSILE_RANGE = 1200.0f; // Unlimited range
const float Projectile::MISSILE_SIZE = 25.0f; // Adjust as needed
